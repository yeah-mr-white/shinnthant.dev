    ...
    return (
        <div className="flex min-h-screen items-center justify-center">
            <div className="relative">
                ...
                <div className="left animation-delay-4000 absolute -left-12 -top-12 h-96 w-96 animate-blob rounded-full bg-greenGradient opacity-25 blur-3xl filter"></div>
                ...
                <div className="relative flex h-[475px] w-[510px] items-center justify-between rounded-lg border border-borderColor bg-canvasBg shadow-customInset">
                    {/* Left Canvas*/}
                    <div className="ml-8 h-[405px] w-[238px] rounded-lg bg-snakeBoardBg shadow-snakeBoardBoxShadow">
                        <div className=""></div>
                    </div>
                    {/* Left Canvas*/}
                </div>
